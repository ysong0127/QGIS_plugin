...
class SaveAttributes:
    ...
    def run(self):
        ...
        selectedLayer = layers[0].layer()
        fieldnames = [field.name() for field in selectedLayer.fields()]
        
        #for f in selectedLayer.getFeatures():
        self.dlg.label.setText(fieldnames[0])
        for fieldname in fieldnames:
            self.dlg.label.setText(fieldname)
            
        #for f in selectedLayer.getFeatures():
            #self.dlg.label.setText(f)
        
        for f in selectedLayer.getFeatures():
            self.dlg.label.setText(f['INCLUSION'])
